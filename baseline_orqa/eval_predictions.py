#!/usr/bin/env python3
"""
Evaluate Baseline 2 predictions and log to wandb.

Usage::

    python baseline_orqa/eval_predictions.py \\
        --gt data_pipeline/samples/test.jsonl \\
        --predictions predictions/pred_autoregressive.jsonl \\
        --names b2_autoregressive \\
...
def main() -> None:
    ...
    parser.add_argument("--model-info", type=str, default="")
